...
def open_reading_comprehension():
    window = tk.Toplevel()
    window.title("Compréhension lecture")
    ...
    texte = tk.Label(
        content_frame,
        text="A Visit to the Science Museum.Last Friday, a group of students visited the science museum in their city. They arrived at 9 a.m. with their teacher, Mr. Brown. The museum was large and full of interesting exhibits about space, animals, technology, and the human body." \
...
#Réponse
    ...
    tk.Radiobutton(
        content_frame,
        text="B. Watching a film about planets",
        variable=choice_vars[2],
        value=2
    ).pack(anchor="w", padx=10, pady=2)
    tk.Radiobutton(
    ...
    tk.Radiobutton(
        content_frame,
        text="D. They thought it was fun and educational",
        variable=choice_vars[9],
        value=4
    ).pack(anchor="w", padx=10, pady=2)
